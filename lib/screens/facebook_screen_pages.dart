        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Row(
              ...
              child: Center(
                  child: Text("P",style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold, color: facebook_grey_color),),
              ),
            ),
                ),
                Column(children: <Widget>[
                  Text("PitiDev",style: TextStyle(fontSize: 18,color: Colors.black, fontWeight: FontWeight.bold,)),
